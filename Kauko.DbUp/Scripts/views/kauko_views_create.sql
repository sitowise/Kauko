...
SELECT
    ...
    IV.register_id AS identifier_value_register_id,
    IV.register_name AS identifier_value_register_name,
    TV.value AS text_value,
    TV.syntax AS text_value_syntax,
...
LEFT JOIN $SCHEMANAME$.numeric_range_value NR ON NR.numeric_range_value_uuid = SI.fk_numeric_range_value
