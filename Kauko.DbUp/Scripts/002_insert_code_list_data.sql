...
INSERT INTO code_lists.detail_plan_addition_information_kind (id, codevalue, uri, preflabel_fi, preflabel_sv, description_fi) VALUES
(1, 'tyyppi', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/tyyppi', 'Tyyppi', 'Typ', 'Koodistoa jäsentävä otsikkotason koodi, jota ei käytetä kaavamääräyksissä. Kaavamääräysten tyypit tulisi luokitella kaavoissa tarkemmin niitä kuvaavalla kaavamääräyksen lisätiedon laji-koodiarvolla.'),
(2, 'paakayttotarkoitus', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/paakayttotarkoitus', 'Pääkäyttötarkoitus', 'Huvudsakligt användningsändamål', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka muodostaa aluevarauksen. Kaavamääräyksen tyypiksi voidaan määritellä pääkäyttötarkoitus ainoastaan, mikäli kaavamääräys liittyy kaavakohteeseen, joka on geometrialtaan alue.'),
(3, 'osaAlue', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/osaAlue', 'Osa-alue', 'Delområde', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka muodostaa osa-alueen, alueen osan tai erityisominaisuutta osoittavan alueen. Kaavamääräyksen tyypiksi voidaan määritellä osa-alue ainoastaan, mikäli kaavamääräys liittyy kaavakohteeseen, joka on geometrialtaan alue.'),
(4, 'poisluettavaKayttotarkoitus', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/poisluettavaKayttotarkoitus', 'Poisluettava käyttötarkoitus', 'Användningsändamål som ska utelämnas', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, jolla ei sallita kaavamääräyksen lisätiedon lajille annettavan koodiarvon mukaista käyttötarkoitusta. Lisätiedon lajille annettavan arvon tulee olla jokin kaavamääräyslaji-koodiston koodiarvoista.'),
(5, 'valiaikainenMaarays', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/valiaikainenMaarays', 'Väliaikainen määräys', 'Temporär bestämmelse', 'Ilmaisee, että kyseessä on väliaikainen kaavamääräys. Kaavamääräyksen lisätiedon "Väliaikainen määräys" tulee sisältyä määräysryhmään, joka sisältää myös sanallisen määräyksen, jossa kerrotaan kuinka kauan kaavamääräys on voimassa.'),
(6, 'vaihtoehtoinen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/vaihtoehtoinen', 'Vaihtoehtoinen', 'Alternativ', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, johon liittyvä määräys on osoitettu vaihtoehtoisena. Lisätietoa voidan käyttää esimerkiksi osoittamaan vaihtoehtoinen tielinjaus silloin, kun nähdään tarkoituksenmukaiseksi jättää yleiskaavaan useampi linjausvaihtoehto esimerkiksi tilanteessa, jossa linjauksen valinta on tarkoituksenmukaista päättää vasta yksityiskohtaisemman suunnittelun yhteydessä. Vaihtoehtojen määrä tulisi yleisesti pyrkiä rajoittamaan kahteen. Jos vaihtoehtojen määrä kasvaa suureksi, on yleensä tarkoituksenmukaisempaa osoittaa tielinjaukset yhteystarpeina. Vaihtoehtoisen tielinjauksen osoittamisen edellytyksenä on, että linjausvaihtoehdon sijainti ja suhde alueen muuhun maankäyttöön on selvitetty ja että vaihtoehdolla ei ole oleellista merkitystä kaavassa esitettyyn muuhun maankäyttöön.'),
(7, 'ohjeellinenSijainti', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/ohjeellinenSijainti', 'Ohjeellinen sijainti', 'Riktgivande läge', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka on määräyksen perusteella sijainniltaan ohjeellinen. Ohjeellisina sijainteina osoitetaan yleis- ja maakuntakaavoissa esimerkiksi tie- ja katuyhteydet, jotka perustuvat todettuun tieliikenteen yhteystarpeeseen ja joiden sijaintiin tai toteuttamiseen liittyy sellaista epävarmuutta, ettei tien linjausta täsmällisesti osoittavan esitystavan käyttöön ole riittäviä perusteita. Kaavamääräyksen lisätiedon laji koodiarvoa "ohjeellinen sijainti" käytetään todennäköisen alueidenkäyttötarpeen toteuttamismahdollisuuksien varmistamiseksi muun muassa silloin, kun tien sijainnista on käytettävissä vain alustavia suunnitelmia tai sijaintiin liittyy muutoin tavanomaista suurempaa epävarmuutta. Asemakaavoissa koodia voidaan käyttää esimerkiksi osoitettaessa rakennusala ohjeellisena.'),
(8, 'ehdottomastiNoudatettava', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/ehdottomastiNoudatettava', 'Ehdottomasti noudatettava', 'Iakttas ovillkorligen', 'Ilmaisee, että kaavakohteeseen liittyvää kaavamääräystä tulisi toteuttaa sellaisenaan. Kaavamääräyksen lisätiedon laji koodiarvoa "ehdottomasti noudatettava" käytetään ilmaisemaan, että kaavamääräykselle annettu arvo on velvoittava esimerkiksi ehdottomasti käytettävä kerrosluku. Koodiarvo voidaan antaa lisätietona ainoastaan kaavamääräyksille, joiden kaavamääräyslaji-koodiarvo kuuluu suure-määrityshierarkiaan.'),
(9, 'yhteystarve', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/yhteystarve', 'Yhteystarve', 'Behov av förbindelse', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, johon liittyvä määräys on osoitettu yhteystarpeena. Yhteystarpeina osoitetaan sellaiset yhteydet, joiden tarve on voitu todeta, mutta joiden sijaintiin tai toteuttamiseen liittyy niin huomattavaa epävarmuutta, ettei ohjeellisen tai vaihtoehtoisen linjauksen osoittaminen ole mahdollista. Tiesuunnitelman laatiminen ei voi perustua yhteystarvetta osoittavaan määräykseen.'),
(10, 'hairionTorjuntatarve', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/hairionTorjuntatarve', 'Häiriön torjuntatarve', 'Behov av att bekämpa störning', 'Koodistoa jäsentävä otsikkotason koodi, jota ei käytetä kaavamääräyksissä. Häiriön torjuntatarvetta kuvaavat kaavamääräykset tulisi luokitella kaavoissa tarkemmin niitä kuvaavalla kaavamääräyksen lisätiedon laji-koodiarvolla.'),
(11, 'meluntorjuntatarve', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/meluntorjuntatarve', 'Meluntorjuntatarve', 'Behov av bullerbekämpning', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, johon liittyy melun torjunnan tarvetta.'),
(12, 'ymparistoTaiMaisemavaurionKorjaustarve', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/ymparistoTaiMaisemavaurionKorjaustarve', 'Ympäristö- tai maisemavaurion korjaustarve', 'Behov av att reparera miljö- eller landskapsskada', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, johon liittyy ympäristö- tai maisemavaurion korjaustarve.'),
(13, 'terveyshaitanPoistamistarve', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/terveyshaitanPoistamistarve', 'Terveyshaitan poistamistarve', 'Behov av att avlägsna sanitär olägenhet', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, johon liittyy terveyshaitan poistamistarve.'),
(14, 'merkittavyys', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/merkittavyys', 'Merkittävyys', 'Betydelse', 'Koodistoa jäsentävä otsikkotason koodi, jota ei käytetä kaavamääräyksissä. Kaavakohteen merkittävyyttä kuvaavat kaavamääräykset tulisi luokitella kaavoissa tarkemmin niitä kuvaavalla kaavamääräyksen lisätiedon laji-koodiarvolla.'),
(15, 'kansainvalinen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kansainvalinen', 'Kansainvälinen', 'Internationell', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka on merkitykseltään kansainvälinen.'),
(16, 'valtakunnallinen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/valtakunnallinen', 'Valtakunnallinen', 'Nationell', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka on merkitykseltään valtakunnallinen. Tällaisia kohteita ovat esimerkiksi valtakunnallisesti arvokkaat maisema-alueet tai valtakunnallisesti merkittävät rakennetut kulttuuriympäristöt.'),
(17, 'maakunnallinen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/maakunnallinen', 'Maakunnallinen', 'Landskapsmässig', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka on merkitykseltään maakunnallinen. Tällaisia kohteita ovat esimerkiksi maakunnallisesti arvokkaat maisema-alueet tai maakunnallisesti merkittävät rakennetut kulttuuriympäristöt.'),
(18, 'seudullinen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/seudullinen', 'Seudullinen', 'Regional', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka on merkitykseltään seudullinen. Tällaisia kohteita ovat esimerkiksi seudullisesti tärkeät pyöräilyreitit tai seudulliseen liityntäpysäköintiin osoitettavat pysäköintialueet.'),
(19, 'alueellinen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/alueellinen', 'Alueellinen', 'Områdesmässig', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka on merkitykseltään alueellinen.'),
(20, 'paikallinen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/paikallinen', 'Paikallinen', 'Lokal', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka on merkitykseltään paikallinen. Tällaisia kohteita voivat olla esimerkiksi paikallisesti merkittävät rakennetut kulttuuriympäristöt tai suojeltavat rakennukset. Koodia käytetään myös ilmaisemaan esimerkiksi palveluita koskevien aluevarausten osalta, että kyseessä on lähipalveluille varattava alue.'),
(21, 'eriTahojenTarpeisiinVaraaminen', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/eriTahojenTarpeisiinVaraaminen', 'Eri tahojen tarpeisiin varaaminen', 'Reservering för olika aktörers behov', 'Koodistoa jäsentävä otsikkotason koodi, jota ei käytetä kaavamääräyksissä. Kaavakohteen varaamista eri tahojen tarpeisiin kuvaavat kaavamääräykset tulisi luokitella kaavoissa tarkemmin niitä kuvaavalla kaavamääräyksen lisätiedon laji-koodiarvolla.'),
(22, 'varattuKunnanKayttoon', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/varattuKunnanKayttoon', 'Varattu kunnan käyttöön', 'Reserverat för kommunen', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka varataan kunnan käyttöön.'),
(23, 'varattuValtionKayttoon', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/varattuValtionKayttoon', 'Varattu valtion käyttöön', 'Reserverat för staten', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka varataan valtion käyttöön.'),
(24, 'varattuYleiseenKayttoon', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/varattuYleiseenKayttoon', 'Varattu yleiseen käyttöön', 'Reserverat för allmänt bruk', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka varataan yleiseen käyttöön.'),
(25, 'varattuYksityiseenKayttoon', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/varattuYksityiseenKayttoon', 'Varattu yksityiseen käyttöön', 'Reserverat för privat bruk', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka varataan yksityiseen käyttöön.'),
(26, 'varattuAlueenSisaiseenKayttoon', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/varattuAlueenSisaiseenKayttoon', 'Varattu alueen sisäiseen käyttöön', 'Reserverat för användning inom området', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka varataan alueen sisäiseen käyttöön.'),
(27, 'ymparistomuutoksenLaji', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/ymparistomuutoksenLaji', 'Ympäristömuutoksen laji', 'Typ av miljöförändring', 'Koodistoa jäsentävä otsikkotason koodi, jota ei käytetä kaavamääräyksissä. Ympäristön muutosta kuvaavat kaavamääräykset tulisi luokitella kaavoissa tarkemmin niitä kuvaavalla kaavamääräyksen lisätiedon laji-koodiarvolla.'),
(28, 'olemassaOleva', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/olemassaOleva', 'Olemassa oleva', 'Befintlig', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka osoittaa alueella jo olemassa olevaa alueidenkäyttötarkoitusta.'),
(29, 'sailytettava', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/sailytettava', 'Säilytettävä', 'Bevaras', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka tulisi säilyttää. Kaavassa voidaan osoittaa säilytettäväksi esimerkiksi kaupunkikuvallisesti tärkeä puurivi tai vesialue, joka sijoittuu satama-alueelle. Säilyttämistä koskeva lisätieto voidaan antaa myös kohteille, joilla on esimerkiksi säilytettäviä kulttuuriympäristöarvoja ja jotka tulee siksi osoittaa ympäristöltään säilytettävinä. Mikäli alueeseen liittyy erityisiä ympäristöarvoja, joiden säilyminen halutaan kaavamääräyksellä turvata, tulisi kaavakohteeseen liittää täsmentävä sanallinen määräys. Kaavamääräyksessä tulisi mainita mitä ja miten kyseisiä arvoja pyritään säilyttämään, esimerkiksi todeten, että alueella olevien rakennusten ja pihapiirien ominaispiirteet on säilytettävä. Mikäli kaavakohde halutaan nimenomaisesti suojella, tulisi kaavakohteeseen liittää suojelua ilmaiseva kaavamääräyslaji-koodiarvo.'),
(30, 'uusi', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/uusi', 'Uusi', 'Ny', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka osoittaa alueelle suunniteltua uutta alueidenkäyttötarkoitusta. Rakentamiseen osoitettavien alueiden osalta koodia voidaan käyttää silloin, kun alueella ei vielä kaavaa laadittaessa ole olemassa olevaa rakennuskantaa tai kun on kyse kokonaan uudesta tiestä tai muusta linjauksesta. Koodia voidaan käyttää myös osoittamaan rakentamattomien alueiden uutta käyttötarkoitusta esimerkiksi tilanteessa, jossa maa- ja metsätaloustalouskäytössä ollut alue osoitetaan retkeily- ja ulkoilualueeksi.'),
(31, 'olennaisestiMuuttuva', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/olennaisestiMuuttuva', 'Olennaisesti muuttuva', 'Förändras väsentligt', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka osoittaa alueelle suunniteltua olennaisesti muuttuvaa alueidenkäyttötarkoitusta. Rakentamiseen osoitettavien alueiden osalta koodia voidaan käyttää silloin, kun alueella on jo olemassa olevaa rakennuskantaa, mutta alueeseen käyttötarkoitus muuttuu tai alueelle osoitetaan esimerkiksi erittäin merkittävää uudisrakentamista tai muita toimenpiteitä, joiden seurauksena alueen luonne muuttuu olennaisesti, vaikka käyttötarkoitus säilyy samana.'),
(32, 'reservialue', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/reservialue', 'Reservialue', 'Reservområde', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, joka osoittaa alueelle suunniteltua mahdollista uutta alueidenkäyttötarkoitusta. Koodia voidaan käyttää silloin, kun kaavoituksen yhteydessä on todettu mahdolliseksi osoittaa kaavakohteen osoittaamalle alueelle uudisrakentamista, mutta sen toteutukseen liittyy epävarmuutta, jonka takia aluetta ei ole tarkoituksenmukaista osoittaa uutena.'),
(33, 'kehitettava', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kehitettava', 'Kehitettävä', 'Utvecklas', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, jolla osoitetaan alueet, joiden perusluonnetta ei ole tarkoitus muuttaa, mutta joilla on tarpeen tehdä erilaisia muutos- ja parannustoimenpiteitä. Keskeneräisillä alueilla tulee usein myös kysymykseen ympäristöön sopiva täydennysrakentaminen. Määräyksiä laadittaessa on syytä miettiä erityisesti muutoksille asetettavia reunaehtoja. Koodia voidaan käyttää osoittamaan myös esimerkiksi joukkoliikenteen kehittämiskäytäviä eli olemassa olevia joukkoliikennereittejä, joita on tarkoitus kehittää.'),
(34, 'merkittavastiParannettava', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/merkittavastiParannettava', 'Merkittävästi parannettava', 'Förbättras avsevärt', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, johon kohdistuu merkittäviä muutoksia. Koodia käytetään osoittaamaan, että kysymys kaavakohteeseen kohdistuvista todella merkittävistä muutoksista, esimerkiksi tasoliittymien muuttamisesta eritasoliittymiksi, tien linjauksen merkittävästä parantamisesta tai yksiajorataisen tien muuttamisesta kaksiajorataiseksi. Vähäinen, pääasiassa nykyisellä paikalla tapahtuva tien parantaminen ei ole riittävä peruste merkinnän käyttämiselle. Myöskään tieluokan muuttaminen ei sellaisenaan ole peruste “merkittävästi parannettavan tieosuuden” osoittamiselle.'),
(35, 'eheytettavaTaiTiivistettava', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/eheytettavaTaiTiivistettava', 'Eheytettävä tai tiivistettävä', 'Förenhetligas eller förtätas', 'Ilmaisee, että kaavamääräys liittyy kaavakohteeseen, johon kohdistuu alueen eheyttämiseen tai tiivistämiseen tähtääviä toimenpiteitä, kuten täydennysrakentamista.'),
(36, 'rakentamisenOhjaus', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/rakentamisenOhjaus', 'Rakentamisen ohjaus', 'Styrning av byggandet', 'Koodistoa jäsentävä otsikkotason koodi, jota ei käytetä kaavamääräyksissä. Rakentamisen ohjaukseen liittyvät kaavamääräykset tulisi luokitella kaavoissa tarkemmin niitä kuvaavalla kaavamääräyksen lisätiedon laji-koodiarvolla.'),
(37, 'kerroksetJotaMaaraysKoskee', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kerroksetJotaMaaraysKoskee', 'Kerrokset, jota määräys koskee', 'Våningar som bestämmelsen gäller', 'Ilmaisee, että kaavamääräys kohdistuu vain tiettyyn kerrokseen tai tietyihin kerroksiin. Kaavamääräyksen lisätiedolle annetaan arvoksi arvoväli, joka kertoo mihin kerroksiin määräys kohdistuu. Mikäli määräys halutaan kohdistaa vain yhteen kerrokseen, esimerkiksi ensimmäiseen kerrokseen, annetaan arvoväliksi 1...1.'),
(38, 'kayttotarkoituskohdistus', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kayttotarkoituskohdistus', 'Käyttötarkoituskohdistus', 'Allokering av användningsändamålet', 'Ilmaisee, että kaavamääräys kohdistuu vain tiettyyn käyttötarkoitukseen. Kaavamääräyksen lisätiedolle annetaan arvoksi kaavamääräyslaji-koodiston koodiarvo, joka kuvaa käyttötarkoitusta, johon määräys kohdistuu. Mikäli määräys halutaan kohdistaa useampaan käyttötarkoitukseen, tulee kaavamääräykselle antaa useampi käyttötarkoituksen kohdistusta osoittava lisätieto.'),
(39, 'kayttotarkoituksenOsuusKerrosalastaK-m2', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kayttotarkoituksenOsuusKerrosalastaK-m2', 'Käyttötarkoituksen osuus kerrosalasta (k-m2)', 'Användningsändamålets andel av våningsytan (m2-vy)', 'Ilmaisee, että kaavamääräyksellä kohdistetaan tietty määrä kaavakohteelle osoitetusta rakennusoikeudesta kaavamääräyksen osoittamaan käyttötarkoitukseen. Kaavamääräykselle annetaan arvoksi positiivinen kokonaisluku, jonka yksikkönä on kerrosneliömetri.'),
(40, 'kayttotarkoituksenOsuusKerrosalastaPros', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kayttotarkoituksenOsuusKerrosalastaPros', 'Käyttötarkoituksen osuus kerrosalasta (%)', 'Användningsändamålets andel av våningsytan (%)', 'Ilmaisee, että kaavamääräyksellä kohdistetaan tietty osuus kaavakohteelle osoitetusta rakennusoikeudesta kaavamääräyksen osoittamaan käyttötarkoitukseen. Kaavamääräykselle annetaan arvoksi positiivinen kokonaisluku, jonka yksikkönä on prosentti.'),
(41, 'kayttotarkoituksenOsuusRakennustilavuudestaK-m3', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kayttotarkoituksenOsuusRakennustilavuudestaK-m3', 'Käyttötarkoituksen osuus rakennustilavuudesta (k-m3)', 'Användningsändamålets andel av byggnadsvolymen (m3-vy)', 'Ilmaisee, että kaavamääräyksellä kohdistetaan tietty määrä kaavakohteelle osoitetusta rakennusoikeudesta kaavamääräyksen osoittamaan käyttötarkoitukseen. Kaavamääräykselle annetaan arvoksi positiivinen kokonaisluku, jonka yksikkönä on kuutiometri.'),
(42, 'kayttotarkoituksenOsuusRakennustilavuudestaPros', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kayttotarkoituksenOsuusRakennustilavuudestaPros', 'Käyttötarkoituksen osuus rakennustilavuudesta (%)', 'Användningsändamålets andel av byggnadsvolymen (%)', 'Ilmaisee, että kaavamääräyksellä kohdistetaan tietty osuus kaavakohteelle osoitetusta rakennusoikeudesta kaavamääräyksen osoittamaan käyttötarkoitukseen. Kaavamääräykselle annetaan arvoksi positiivinen kokonaisluku, jonka yksikkönä on prosentti.'),
(43, 'kayttotarkoituksenOsuusMaapintaAlasta', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/kayttotarkoituksenOsuusMaapintaAlasta', 'Käyttötarkoituksen osuus maapinta-alasta', 'Användningsändamålets andel av landarealen', 'Ilmaisee, että kaavamääräyksellä kohdistetaan tietty osuus kaavakohteen kuvaaman alueen pinta-alasta kaavamääräyksen osoittamaan käyttötarkoitukseen. Kaavamääräykselle annetaan arvoksi positiivinen kokonaisluku, jonka yksikkönä on prosentti.'),
(44, 'rakennusluvanPeruste', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/rakennusluvanPeruste', 'Rakennusluvan peruste', 'Grund för byggnadstillståndet', 'Ilmaisee, että kaavakohteeseen liittyvää määräystä voidaan käyttää rakennusluvan perusteena suoraan rakentamista ohjaavissa yleiskaavoissa.'),
(45, 'rakentamistapaohjeHuomioitava', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/rakentamistapaohjeHuomioitava', 'Rakentamistapaohje huomioitava', 'Anvisningen om byggnadssätt ska beaktas', 'Ilmaisee, että kaavakohteeseen liittyen on annettu rakentamistapa, joka tulee huomioida.'),
(46, 'sitovaTonttijakoLaadittava', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/sitovaTonttijakoLaadittava', 'Sitova tonttijako laadittava', 'Bindande tomtindelning ska utarbetas', 'Ilmaisee, että kaavamääräyksellä määrätään, että kaavakohteen alueelle tulee laatia erillinen sitova tonttijako.'),
(47, 'tontilleAjoSallittu', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/tontilleAjoSallittu', 'Tontille ajo sallittu', 'Körning till tomt tillåten', 'Ilmaisee, että kaavamääräyksellä määrätään, että kaavakohteen alueella tontille ajo on sallittu.'),
(48, 'VaarallistenKemikaalienValmistusJaVarastointiSallittu', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/VaarallistenKemikaalienValmistusJaVarastointiSallittu', 'Vaarallisten kemikaalien valmistus ja varastointi sallittu', 'Tillverkning och upplagring av farliga kemikalier tillåten', 'Ilmaisee, että kaavamääräyksellä määrätään, että kaavakohteen alueella vaarallisten kemikaalien valmistus ja varastointi sallittu.'),
(49, 'ymparistoAsettaaToiminnanLaadulleErityisiaVaatimuksia', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/ymparistoAsettaaToiminnanLaadulleErityisiaVaatimuksia', 'Ympäristö asettaa toiminnan laadulle erityisiä vaatimuksia', 'Miljön ställer särskilda krav på verksamhetens art', 'Ilmaisee, että kaavamääräyksellä määrätään, että kaavakohteen alueella ympäristö asettaa toiminnan laadulle erityisiä vaatimuksia.'),
(50, 'melunLahde', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/melunLahde', 'Melun lähde', 'Bullerkälla', 'Ilmaisee, että kaavamääräyksellä osoitettu käyttötarkoitus on melun lähde.'),
(51, 'autopaikkojenSijoittuminenSallittu', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/autopaikkojenSijoittuminenSallittu', 'Autopaikkojen sijoittuminen sallittu', 'Placering av bilplatser tillåten', 'Ilmaisee, että kaavamääräyksellä osoitetaan, että alueelle sallitaan autopaikkojen sijoittuminen. Laki määrää autopaikkojen järjestämisestä ja mahdollisuudesta sijoittua alueen ulkopuolelle.'),
(52, 'maanalainenTila', 'http://uri.suomi.fi/codelist/rytj/RY_Kaavamaarayksen_Lisatiedonlaji/code/maanalainenTila', 'Maanalainen tila', 'Underjordiskt utrymme', 'Ilmaisee, että kaavamääräyksellä määrätään, että kaavakohde on osoitettu toteutettavaksi maanalaisena tilana.');
...
INSERT INTO code_lists.detail_plan_theme VALUES (1, '01', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/01', 'Alue- ja yhdyskuntarakenne', 'Region- och samhällsstruktur', 'Ilmaisee, että kaavamääräys liittyy temaattisesti alue- ja yhdyskuntarakenteeseen.', 'Anger att temat för planbestämmelsen är region- och samhällsstruktur.');
INSERT INTO code_lists.detail_plan_theme VALUES (2, '02', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/02', 'Sekoittuneet toiminnot', 'Blandade funktioner', 'Ilmaisee, että kaavamääräys liittyy temaattisesti sekoittuneisiin toimintoihin. Sekoittuneiden toimintojen teemaan voidaan luokitella esimerkiksi määräykset, joilla mahdollistetaan alueen käyttäminen useampaan kuin yhteen käyttötarkoitukseen.', 'Anger att temat för planbestämmelsen är blandade funktioner. I temat blandade funktioner kan man klassificera till exempel bestämmelser med vilka man möjliggör användning av området för flera än ett användningsändamål.');
INSERT INTO code_lists.detail_plan_theme VALUES (3, '03', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/03', 'Asuminen', 'Boende', 'Ilmaisee, että kaavamääräys liittyy temaattisesti asumiseen.', 'Anger att temat för planbestämmelsen är boende.');
INSERT INTO code_lists.detail_plan_theme VALUES (4, '04', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/04', 'Työpaikat', 'Arbetsplatser', 'Ilmaisee, että kaavamääräys liittyy temaattisesti työpaikkatoimintoihin.', 'Anger att temat för planbestämmelsen är arbetsplatsfunktioner.');
INSERT INTO code_lists.detail_plan_theme VALUES (5, '05', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/05', 'Elinkeinot', 'Näringar', 'Ilmaisee, että kaavamääräys liittyy temaattisesti elinkeinoihin.', 'Anger att temat för planbestämmelsen är näringar.');
INSERT INTO code_lists.detail_plan_theme VALUES (6, '06', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/06', 'Matkailu', 'Turism', 'Ilmaisee, että kaavamääräys liittyy temaattisesti matkailuun.', 'Anger att temat för planbestämmelsen är turism.');
INSERT INTO code_lists.detail_plan_theme VALUES (7, '07', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/07', 'Palvelut', 'Tjänster', 'Ilmaisee, että kaavamääräys liittyy temaattisesti palveluihin.', 'Anger att temat för planbestämmelsen är tjänster.');
INSERT INTO code_lists.detail_plan_theme VALUES (8, '08', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/08', 'Kauppa', 'Handel', 'Ilmaisee, että kaavamääräys liittyy temaattisesti kauppaan ja kaupallisiin toimintoihin.', 'Anger att temat för planbestämmelsen är handel och kommersiell verksamhet.');
INSERT INTO code_lists.detail_plan_theme VALUES (9, '09', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/09', 'Teollisuus', 'Tillverkning', 'Ilmaisee, että kaavamääräys liittyy temaattisesti teollisuuteen ja teollisuutoimintoihin', 'Anger att temat för planbestämmelsen är tillverkning och industriell verksamhet.');
INSERT INTO code_lists.detail_plan_theme VALUES (10, '10', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/10', 'Julkishallinto', 'Offentlig förvaltning', 'Ilmaisee, että kaavamääräys liittyy temaattisesti julkishallintoon.', 'Anger att temat för planbestämmelsen är offentlig förvaltning.');
INSERT INTO code_lists.detail_plan_theme VALUES (11, '11', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/11', 'Alkutuotanto', 'Primärproduktion', 'Ilmaisee, että kaavamääräys liittyy temaattisesti alkutuotantoon.', 'Anger att temat för planbestämmelsen är primärproduktion.');
INSERT INTO code_lists.detail_plan_theme VALUES (12, '12', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/12', 'Liikenne', 'Trafik', 'Ilmaisee, että kaavamääräys liittyy temaattisesti liikenteeseen ja liikennejärjestelmään.', 'Anger att temat för planbestämmelsen är trafik och trafiksystem.');
INSERT INTO code_lists.detail_plan_theme VALUES (13, '13', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/13', 'Infrastruktuuri', 'Infrastruktur', 'Ilmaisee, että kaavamääräys liittyy temaattisesti fyysiseen infrastruktuuriin.', 'Anger att temat för planbestämmelsen är fysisk infrastruktur.');
INSERT INTO code_lists.detail_plan_theme VALUES (14, '14', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/14', 'Erityistoiminnot', 'Särskild funktioner', 'Ilmaisee, että kaavamääräys liittyy erityistoimintoihin.', 'Anger att temat för planbestämmelsen är särskilda funktioner.');
INSERT INTO code_lists.detail_plan_theme VALUES (15, '15', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/15', 'Energiantuotanto', 'Energiproduktion', 'Ilmaisee, että kaavamääräys liittyy temaattisesti energian tuotantoon.', 'Anger att temat för planbestämmelsen är energiproduktion.');
INSERT INTO code_lists.detail_plan_theme VALUES (16, '16', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/16', 'Kulttuuri', 'Kultur', 'Ilmaisee, että kaavamääräys liittyy temaattisesti kulttuuriympäristöön, kulttuuriympäristöarvoihin tai kulttuuria palveleviin toimintoihin.', 'Anger att temat för planbestämmelsen är kulturmiljö, kulturmiljövärden eller funktioner som tjänar kulturen.');
INSERT INTO code_lists.detail_plan_theme VALUES (17, '17', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/17', 'Luonto', 'Natur', 'Ilmaisee, että kaavamääräys liittyy temaattisesti luonnon ympäristöön, luontoarvoihin, viherrakenteeseen tai ekosysteemipalveluihin.', 'Anger att temat för planbestämmelsen är naturmiljö, naturvärden, grönstruktur eller ekosystemtjänster.');
INSERT INTO code_lists.detail_plan_theme VALUES (18, '18', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/18', 'Virkistys ja vapaa-aika', 'Rekreation och fritid', 'Ilmaisee, että kaavamääräys liittyy temaattisesti virkistykseen ja/tai vapaa-aikaan.', 'Anger att temat för planbestämmelsen är rekreation och/eller fritid.');
INSERT INTO code_lists.detail_plan_theme VALUES (19, '19', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/19', 'Vesi', 'Vatten', 'Ilmaisee, että kaavamääräys liittyy temaattisesti vesistöihin, vesistön käyttöön, vesien käsittelyyn tai sinirakenteeseen.', 'Anger att temat för planbestämmelsen är vattendrag, användning av vattendrag, hantering av vatten eller blåstruktur.');
INSERT INTO code_lists.detail_plan_theme VALUES (20, '20', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/20', 'Suojelu', 'Skydd', 'Ilmaisee, että kaavamääräys liittyy temaattisesti erilaisten arvojen ja kohteiden suojeluun.', 'Anger att temat för planbestämmelsen är skydd av olika värden och objekt.');
INSERT INTO code_lists.detail_plan_theme VALUES (21, '21', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/21', 'Ympäristöarvojen vaaliminen', 'Värnande om miljövärden', 'Ilmaisee, että kaavamääräys liittyy temaattisesti erilaisten ympäristöarvojen vaalimiseen ja edistämiseen.', 'Anger att temat för planbestämmelsen är värnande om och främjande av olika miljövärden.');
INSERT INTO code_lists.detail_plan_theme VALUES (22, '22', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/22', 'Ympäristöhäiriöt', 'Miljöstörningar', 'Ilmaisee, että kaavamääräys liittyy temaattisesti ympäristöhäiriöihin.', 'Anger att temat för planbestämmelsen är miljöstörningar.');
INSERT INTO code_lists.detail_plan_theme VALUES (23, '23', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/23', 'Rakentamisen ohjaus', 'Styrning av byggandet', 'Ilmaisee, että kaavamääräys liittyy temaattisesti rakentamisen ohjaukseen.', 'Anger att temat för planbestämmelsen är styrning av byggandet.');
INSERT INTO code_lists.detail_plan_theme VALUES (24, '24', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/24', 'Tontin käyttö', 'Tomtanvändning', 'Ilmaisee, että kaavamääräys liittyy temaattisesti tontin käyttöön.', 'Anger att temat för planbestämmelsen är tomtanvändning.');
INSERT INTO code_lists.detail_plan_theme VALUES (25, '25', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/25', 'Kehittäminen', 'Utveckling', 'Ilmaisee, että kaavamääräys liittyy temaattisesti kehittämiseen.', 'Anger att temat för planbestämmelsen är utveckling.');
INSERT INTO code_lists.detail_plan_theme VALUES (26, '99', 'http://uri.suomi.fi/codelist/rytj/kaavoitusteema/code/99', 'Muu kaavoitusteema', 'Annat planläggningstema', 'Ilmaisee, että kaavamääräys liittyy teemaan, jolle kaavoitusteema-koodistosta ei löydy kuvaavaa koodiarvoa.', 'Anger att planbestämmelsen gäller ett tema för vilket det inte finns ett beskrivande kodvärde i kodlistan Planläggningstema.');
...
(1, '01', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/01', 'Kaavan ajanmukaisuuden arviointi', 'Bedömning av planens tidsenlighet', 'Assessment of plan timeliness', 'Kaavan ajanmukaisuus arvioidaan.', 'Planens tidsenlighet bedöms.', 'The timeliness of the plan is assessed.'),
(2, '02', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/02', 'Kaavoitusaloitteen hyväksyminen', 'Godkännande av planläggningsinitiativ', 'Approval of planning initiative', 'Päätös kaavoitusaloitteen hyväksymisestä.', 'Beslut om godkännande av planläggningsinitiativ.', 'Decision on the approval of a planning initiative.'),
(3, '03', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/03', 'Kaavoituksen käynnistäminen', 'Inledande av planläggning', 'Initiation of planning', 'Päätös kaavoituksen käynnistämisestä ja varataan resurssit tietyn kaavan laatimiseen.', 'Beslut om inledande av planläggning och resurser reserveras för att utarbeta en viss plan.', 'A decision on the initiation of planning and the allocation of resources to prepare a specific plan.'),
(4, '04', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/04', 'Osallistumis- ja arviointisuunnitelman nähtäville asettaminen', 'Planen för deltagande och bedömning läggs fram offentligt', 'Presenting the participation and assessment scheme to the public', 'Päätös kaavan osallistumis- ja arviointisuunnitelman nähtäville asettamisesta.', 'Beslut om offentligt framläggande av planen för deltagande och bedömning.', 'Decision to present the plan’s participation and assessment scheme to the public.'),
(5, '05', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/05', 'Kaavan valmisteluaineiston nähtäville asettaminen', 'Offentligt framläggande av beredningsmaterialet som rör planen', 'Presenting the plan preparation material to the public', 'Päätös kaavan valmisteluaineiston nähtäville asettamisesta.', 'Beslut om offentligt framläggande av beredningsmaterialet som rör planen.', 'Decision on presenting the plan to the public.'),
(6, '06', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/06', 'Kaavaluonnoksen nähtäville asettaminen', 'Offentligt framläggande av utkastet till plan', 'Presenting the draft plan to the public', 'Päätös kaavaluonnoksen nähtäville asettamisesta.', 'Beslut om offentligt framläggande av utkastet till plan.', 'Decision to present the draft plan to the public.'),
(7, '07', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/07', 'Kaavaehdotuksen asettaminen lausunnoille', 'Utsändning av planförslaget på remiss', 'Sending a plan proposal out for opinions', 'Maakuntakaavaehdotuksesta pyydetään lausunnot ennen nähtäville asettamista (MRA 13 §).', 'Utlåtande om förslaget till landskapsplan ska begäras före framläggandet (13 § i markanvändnings- och byggförordningen).', 'Opinions on the regional plan proposal are requested before its presentation to the public (section 13 of the Land Use and Building Decree).'),
(8, '08', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/08', 'Kaavaehdotuksen nähtäville asettaminen', 'Offentligt framläggande av planförslaget', 'Presenting the draft proposal to the public', 'Päätös kaavaehdotuksen asettamisesta julkisesti nähtäville.', 'Beslut om offentligt framläggande av planförslaget.', 'Decision to present the plan proposal to the public.'),
(9, '09', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/09', 'Muutetun kaavaehdotuksen nähtäville asettaminen', 'Offentligt framläggande av det ändrade planförslaget', 'Presenting the amended plan proposal to the public', 'Päätös kaavaehdotuksen asettamisesta uudelleen julkisesti nähtäville siihen tehtyjen olennaisten muutosten johdosta.', 'Beslut om att på nytt lägga fram planförslaget offentligt med anledning av de väsentliga ändringar som gjorts i det.', 'Decision to present the plan proposal to the public again due to essential changes made to it.'),
(10, '10', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/10', 'Kaavaprosessin keskeyttäminen', 'Avbrytande av planprocessen', 'Interruption of plan process', 'Päätös kaavan valmistelun keskeyttämisestä ennen kaavan viemistä hyväksymiskäsittelyyn.', 'Beslut om att avbryta beredningen av planen innan planen behandlas vidare för godkännande.', 'Decision to suspend the preparation of the plan before submitting it to the approval process.'),
(11, '11A', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/11A', 'Kaavan hyväksyminen', 'Godkännande av planen', 'Plan approval', 'Valtuusto tai lautakunta tekee päätöksen kaavan hyväksymisestä.', 'Fullmäktige eller nämnden beslutar om godkännande av planen.', 'The council or committee makes the decision to approve the plan.'),
(12, '11B', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/11B', 'Kaavan ja sitovan tonttijaon hyväksyminen', 'Godkännande av planen och den bindande tomtindelningen', 'Approval of plan and binding plot division', 'Kun sitova tonttijako hyväksytään osana asemakaavaa.', 'Då den bindande tomtindelningen godkänns som en del av detaljplanen.', 'When a binding plot division is approved as part of a local detailed plan.'),
(13, '12', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/12', 'Kaavan hyväksyminen oikaisukehotuksen johdosta', 'Godkännande av planen med anledning av rättelseuppmaning', 'Plan approval due to rectification reminder', 'Kaavan hyväksymispäätös käsitellään uudelleen oikaisukehotuksen johdosta.', 'Beslutet om godkännande av planen behandlas på nytt med anledning av en rättelseuppmaning.', 'The decision to approve the plan is reconsidered due to a rectification reminder.'),
(14, '13', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/13', 'Kaavan tai sen osan kuuluttaminen voimaan ennen kaavan lainvoimaisuutta', 'Kungörelse av planen eller en del av den innan planen vunnit laga kraft', 'Announcement of a plan or part thereof as valid before legal validity', 'Päätös kuuluttaa kaava tai sen osa voimaan ennen kaavan lainvoimaisuutta.', 'Beslut att kungöra planen eller en del av den innan planen vunnit laga kraft.', 'The decision to announce a plan or part thereof as valid before its legal validity.'),
(15, '14', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/14', 'Kaavan kumoaminen', 'Upphävande av planen', 'Plan repeal', 'Valtuusto tai lautakunta tekee päätöksen kaavan kumoamisesta.', 'Fullmäktige eller nämnden beslutar om upphävande av planen.', 'The council or committee makes the decision to repeal the plan.'),
(16, '15', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/15', 'Kaavan kumoaminen osittain', 'Delvis upphävande av planen', 'Plan repeal partially', 'Valtuusto tai lautakunta tekee päätöksen osittaisesta kaavan kumoamisesta.', 'Fullmäktige eller nämnden beslutar om delvis upphävande av planen.', 'The council or committee makes the decision to partially repeal the plan.'),
(17, '16', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/16', 'Valituksen vastineiden hyväksyminen', 'Godkännande av besvärsgenmälen', 'Approval of the rejoinders to the appeal', 'Kunta tai maakunnan liitto hyväksyy hallinto-oikeudelle tai korkeimmalle hallinto-oikeudelle annettavat vastineet.', 'Kommunen eller landskapsförbundet godkänner de genmälen som ges till förvaltningsdomstolen eller högsta förvaltningsdomstolen.', 'The municipality or the regional council approves the rejoinders to be submitted to the administrative court or the Supreme Administrative Court.'),
(18, '17', 'http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/17', 'Kaavan palauttaminen valmisteluun', 'Returnering av planen för beredning', 'Returning plan to preparation', 'Päätös nähtävillä olleen kaavaehdotuksen tai muutoksenhaun myötä jo hyväksytyn kaavan palauttamisesta valmisteluvaiheeseen.', 'Beslut om att ett planförslag som varit framlagt eller en plan som redan godkänts genom ändringsansökan returneras till beredningsskedet.', 'The decision to return to a plan that has already been presented to the public and approved to the preparation stage after a plan proposal or an appeal.');
...
SELECT pg_catalog.setval('code_lists.detail_plan_addition_information_kind_id_seq', 52, true);
...
SELECT pg_catalog.setval('code_lists.detail_plan_theme_id_seq', 26, true);
...
SELECT pg_catalog.setval('code_lists.plan_decision_name_id_seq', 18, true);
