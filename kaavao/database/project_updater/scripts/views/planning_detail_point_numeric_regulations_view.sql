DROP VIEW IF EXISTS SCHEMANAME.planning_detail_point_numeric_regulations_view;

CREATE VIEW SCHEMANAME.planning_detail_point_numeric_regulations_view AS
Select
...
SCHEMANAME.planning_detail_point.identifier As planning_detail_point_id
From
...
SCHEMANAME.planning_detail_point_numeric_value On SCHEMANAME.numeric_value.numeric_value_id =
        SCHEMANAME.planning_detail_point_numeric_value.numeric_id Inner Join
SCHEMANAME.planning_detail_point On SCHEMANAME.planning_detail_point.planning_object_identifier
        = SCHEMANAME.planning_detail_point_numeric_value.planning_detail_point_id